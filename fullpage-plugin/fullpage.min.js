...
!function(e, t, n, o, r) {
    ...
    function wn(e) {
        ...
        for (var t = 1, n = arguments.length; t < n; ++t) {
            ...
            if (o)
                for (var r in o)
                    o.hasOwnProperty(r) && ("[object Object]" !== Object.prototype.toString.call(o[r]) ? e[r] = o[r] : e[r] = wn(e[r], o[r]))
        }
        return e
    }
    function yn(e, t) {
    ...
    function(e, E) {
        ...
        if (!yn(u, Wt)) {
            ...
            var x, i, c, f, a = !1, o = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), l = "ontouchstart"in Rt || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, d = "string" == typeof e ? bn(e)[0] : e, A = En(), s = Ln(), g = !1, t = !0, T = !0, v = [], p = {
                m: {
                    up: !0,
                    down: !0,
                    left: !0,
            ...
            h.destroy = function(e) {
                ...
                e && (xt(0),
                bn("img[data-src], source[data-src], audio[data-src], iframe[data-src]", d).forEach(function(e) {
                    De(e, "src")
                }),
            ...
            h.test = {
                ...
                translate3dH: function() {
                    for (var e = [], t = 0; t < bn(E.sectionSelector, d).length; t++)
            ...
            function() {
                ...
                for (var e = bn(_t), t = 0; t < e.length; t++) {
                    ...
                    E.menu && E.css3 && null != Dn(bn(E.menu)[0], jt) && bn(E.menu).forEach(function(e) {
                        L.appendChild(e)
                    }),
                ...
                E.navigation && function() {
                    ...
                    for (var o = "", r = 0; r < bn(_t).length; r++) {
                        ...
                        o += '<li><a href="#' + i + '"><span class="fp-sr-only">' + we(r, "Section") + "</span><span></span></a>";
        ...
        function re(e) {
            ...
            function() {
                if (o || l) {
                    ...
                    e.removeEventListener(H.touchmove, Te, {
                        passive: !1
                    }),
                    e.addEventListener(H.touchstart, Oe),
                    e.addEventListener(H.touchmove, Te, {
                        passive: !1
                    })
                }
            }()) : (ne(!1),
        ...
        function he(e) {
            ...
            .call(t, e) : Dn(t, E.menu + " [data-menuanchor]") && function(e) {
                !bn(E.menu)[0] || !E.lockAnchors && E.anchors.length || (Un(e),
        ...
        function me(e) {
            ...
            !r && h.shared.isNormalScrollElement && (re(!0),
            h.shared.isNormalScrollElement = !1))) : re(!0)
        }
        function Se() {
            var e = En()
              , t = Ln();
        ...
        function be(e, t, n) {
            ...
            Vn(bn(an, l)[0], a),
            "#fff" !== E.controlArrowColor && (xn(bn(mn, l), {
            ...
            E.slidesNavigation && function(e, t) {
                ...
                for (var o = 0; o < t; o++)
                    Nn(qn('<li><a href="#"><span class="fp-sr-only">' + we(o, "Slide") + "</span><span></span></a></li>"), bn("ul", n)[0]);
                xn(n, {
        ...
        function Ee() {
            ...
            if (!E.autoScrolling || E.scrollBar) {
                ...
                n = bn($t)[0].offsetTop,
                o = n + En(),
                ("up" != t ? n <= Yn() : o >= Yn() + En()) && (yn(bn($t)[0], Xt) || (In(bn($t)[0], Xt),
                Rn(Fn(bn($t)[0]), Xt))),
                !yn(e = f[s], Ft)) {
                    Y = !0;
                    var v, p, h = bn($t)[0], g = Cn(h, _t) + 1, m = ft(e), S = e.getAttribute("data-anchor"), b = Cn(e, _t) + 1, w = bn(rn, e)[0], y = {
                        activeSection: h,
                        sectionIndex: b - 1,
                        anchorLink: S,
                        element: e,
                    ...
                    w && (p = w.getAttribute("data-anchor"),
                    v = Cn(w)),
                    T && (In(e, Ft),
                    Rn(Fn(e), Ft),
        ...
        function Te(e) {
            ...
            if (ke(e)) {
                ...
                K = n.y,
                _ = n.x,
                bn(an, t).length && Math.abs(X - _) > Math.abs(U - K) ? !a && Math.abs(X - _) > Ln() / 100 * E.touchSensitivity && (_ < X ? p.m.right && ue(t) : p.m.left && fe(t)) : E.autoScrolling && T && Math.abs(U - K) > Rt.innerHeight / 100 * E.touchSensitivity && (K < U ? xe("down") : U < K && xe("up"))
            }
        }
        function ke(e) {
        ...
        function Ie(e, t, n) {
            if (null != e) {
                ...
                if (!(d.activeSection == e && !g || E.scrollBar && Yn() === d.dtop && !yn(e, Gt))) {
                    ...
                    E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Wn(bn($t)[0], Gn(p.activeSection, _t)) : Vn(bn($t)[0], Jn(p.activeSection, _t).reverse()),
                    xt(bn($t)[0].offsetTop),
                    He(),
                    ...
                    function(e) {
                        if (E.css3 && E.autoScrolling && !E.scrollBar) {
                            ...
                            pt(t, !0),
                            E.scrollingSpeed ? (clearTimeout(w),
        ...
        function je(e) {
            ...
            t.element = bn(jt)[0]) : (t.options = e,
            t.element = Rt),
            t
        }
        function Pe(e) {
            var t;
            null != (t = e).wrapAroundElements && (t.isMovementUp ? Wn(bn(_t)[0], t.wrapAroundElements) : Vn(bn(_t)[bn(_t).length - 1], t.wrapAroundElements),
            xt(bn($t)[0].offsetTop),
            He()),
        ...
        function ot(e, t, n) {
            ...
            E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && Xn(E.onSlideLeave) && !1 === Re("onSlideLeave", l) ? a = !1 : (In(t, Ft),
            Rn(Fn(t), Ft),
            l.localIsResizing || (Xe(l.prevSlide),
            We(t)),
            !E.loopHorizontal && E.controlArrows && ($n(bn(gn, i), 0 !== l.slideIndex),
            $n(bn(mn, i), null != On(t))),
        ...
        function rt(e) {
            ...
            t = e.slidesNav,
            n = e.slideIndex,
            E.slidesNavigation && null != t && (Rn(bn(Ut, t), Ft),
            In(bn("a", bn("li", t)[n]), Ft)),
        ...
        function ut(e, t) {
            ...
            bn(E.menu).forEach(function(e) {
                E.menu && null != e && (Rn(bn(Ut, e), Ft),
                In(bn('[data-menuanchor="' + n + '"]', e), Ft))
            }),
            o = e,
            r = t,
            E.navigation && null != bn(en)[0] && (Rn(bn(Ut, bn(en)[0]), Ft),
            In(o ? bn('a[href="#' + o + '"]', bn(en)[0]) : bn("a", bn("li", bn(en)[0])[r]), Ft))
        }
        function ft(e) {
            var t = Cn(bn($t)[0], _t)
              , n = Cn(e, _t);
        ...
        function gt(e, t) {
            var n = ht(e);
            if (null != n) {
                var o, r, i, l = (null == (i = bn(on + '[data-anchor="' + (o = t) + '"]', r = n)[0]) && (o = void 0 !== o ? o : 0,
                i = bn(on, r)[o]),
                i);
